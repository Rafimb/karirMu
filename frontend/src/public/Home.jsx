...
import linkCircleIcon from '../assets/img/link-circle.svg';
import boxSearchIcon from '../assets/img/box-search.svg';
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 ${
                ...
                <img src={clockIcon} alt="Efisien" className="w-8 h-8" />
              </div>
            ...
            >
              <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 ${
                ...
                <img src={linkCircleIcon} alt="Integrasi" className="w-8 h-8" />
              </div>
            ...
            >
              <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 ${
                ...
                <img src={boxSearchIcon} alt="Transparansi" className="w-8 h-8" />
              </div>
